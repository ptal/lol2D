  ...
  public static enum GroundTile {
    ...
    public static GroundTile fromASCII(char c) {
      switch (c) {
        ...
        case '*':
          return GroundTile.ROCK;
        case '|':
          return GroundTile.TREE;
        default:
          throw new RuntimeException("No ground tile with the representation `" + c + "`.");
      }
    }
    ...
    public static boolean walkable(GroundTile groundTile) {
      switch (groundTile) {
        ...
        case TREE:
          return false;
        default:
          throw new RuntimeException("Missing GroundTile case in walkable.");
      }
    }
    ...
    public static char stringOf(GroundTile groundTile) {
      switch (groundTile) {
        ...
        case TREE:
          return '|';
        default:
          throw new RuntimeException("Missing GroundTile case in stringOf.");
      }
    }
  }
