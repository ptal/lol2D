...
public class Config {
  ...
  public static final int HP_ARCHER = 10;
  public static final int RANGE_OF_ATTACK_ARCHER = 3;
  ...
  public static final int HP_DRAGON = 10;
  public static final int RANGE_OF_ATTACK_DRAGON = 3;
  public static final int DAMAGE_DRAGON = 5;

  public static final int HP_NASHOR = 15;
  public static final int RANGE_OF_ATTACK_NASHOR = 3;
  public static final int DAMAGE_NASHOR = 5;

  public static final int BOOST_DAMAGES = 5;
  public static final int BOOST_SPEED = 5;
