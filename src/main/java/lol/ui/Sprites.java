...
public class Sprites {
  ...
  public Sprites() {
    ...
    wizardImages[Nexus.BLUE] = new Image("sprites/blue-wizard.png"); //https://craftpix.net/freebies/wizard-character-free-sprite/
    wizardImages[Nexus.RED] = new Image("sprites/red-wizard.png"); //https://craftpix.net/freebies/wizard-character-free-sprite/
